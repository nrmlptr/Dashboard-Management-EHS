                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="<?= base_url('dashboard/');?>" class="site_title"><i class="fa fa-plus-square"></i>   <span class="center">EHS System</span></a>
                        </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <?php if($this->session->userdata('akses') == 1){ ?>
                                        <li><a><i class="fa fa-home"></i>Master Data<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                                <li><a href=<?php echo base_url('dashboard/showKaryawan')?>>Data Karyawan</a></li>
                                                <li><a href="<?= base_url('dashboard/showShift');?>">Data Shift</a></li>
                                                <li><a href="">Data Material</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <li><a><i class="fa fa-desktop"></i>Data Produksi <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?= base_url('produksi/prosesWWT');?>">Input Proses WWT</a></li>
                                            <li><a href="<?= base_url('produksi/showDataPWWT');?>">Data Proses WWT</a></li>
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-link"></i>Portal Sistem<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
